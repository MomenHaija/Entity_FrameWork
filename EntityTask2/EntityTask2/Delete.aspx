<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="EntityTask2.WebForm5" %>
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
									...
									<asp:Button ID="Delete" class="btn btn-primary px-4" runat="server" Text="Save Changes"  />
